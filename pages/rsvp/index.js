    ...
    <>
      <div className={`${styles.aboutus} fade-in`} style={{ opacity: '0' }}>
        ...
        <p className={styles.paragraph} style={{ textAlign: 'center' }}>
          Viacerí z vás ste sa nás pýtali a ponúkali nám svoje pomocné ruky,
          chcem vás preto ubezpečiť, že práve teraz nastal váš čas ako nám
          najlepšie pomôžete.
        </p>
        <p className={styles.paragraph} style={{ textAlign: 'center' }}>
          Pripravili sme pre každého hosťa krátky dotazník a budeme radi ak nám
          ho vyplníte a odošlete :)
        </p>
        <ModalComponent
                        ...
                        >
                          ...
                          >
                            ...
                            <FastField
                              ...
                              label='Iný alkohol'
                              disabled={
                                getIn(values, `guests.${index}.alcohol`) !==
                                'iné'
                              }
                              value={getIn(
                                values,
